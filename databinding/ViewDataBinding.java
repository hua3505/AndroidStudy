...
public abstract class ViewDataBinding extends BaseObservable {
     ...
     * @hide
     */
    protected ViewDataBinding(android.databinding.DataBindingComponent bindingComponent, View root, int
            localFieldCount) {
     ...
     * @hide
     */
    protected static ViewDataBinding bind(android.databinding.DataBindingComponent bindingComponent, View view,
                                          int layoutId) {
     ...
     * @hide
     */
    protected static Object[] mapBindings(android.databinding.DataBindingComponent bindingComponent, View root,
    ...
    protected static void setBindingInverseListener(ViewDataBinding binder,
                                                    ...
                                                    PropertyChangedInverseListener listener) {
     ...
     * @hide
     */
    protected static Object[] mapBindings(android.databinding.DataBindingComponent bindingComponent, View[] roots,
                                          int numBindings, IncludedLayouts includes, SparseIntArray viewsWithIds) {
        Object[] bindings = new Object[numBindings];
    ...
    private static void mapBindings(android.databinding.DataBindingComponent bindingComponent, View view,
        ...
        if (!isBound) {
            // 没有绑定的view，如果设置了id，从viewsWithIds获取对应的index，并加入到bindings数组
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (indexInIncludes >= 0 && child.getTag() instanceof String) {
                    ...
                    if (childTag.endsWith("_0") &&
                        ...
                        // 是include，获取到index，为它生成binding对象，并把view添加到bindings数组中
